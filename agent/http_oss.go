...
func init() {
	...
	registerEndpoint("/v1/acl/bindingrules", []string{"GET"}, (*HTTPServer).ACLRoleBindingRuleList)
	registerEndpoint("/v1/acl/bindingrule", []string{"PUT"}, (*HTTPServer).ACLRoleBindingRuleCreate)
	registerEndpoint("/v1/acl/bindingrule/", []string{"GET", "PUT", "DELETE"}, (*HTTPServer).ACLRoleBindingRuleCRUD)
	registerEndpoint("/v1/acl/idps", []string{"GET"}, (*HTTPServer).ACLIdentityProviderList)
	registerEndpoint("/v1/acl/idp", []string{"PUT"}, (*HTTPServer).ACLIdentityProviderCreate)
	registerEndpoint("/v1/acl/idp/", []string{"GET", "PUT", "DELETE"}, (*HTTPServer).ACLIdentityProviderCRUD)
